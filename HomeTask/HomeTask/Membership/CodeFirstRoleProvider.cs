...
{
    private readonly HomeTaskContext Context;

    public CodeFirstRoleProvider() : base()
    {
    ...
    public override bool RoleExists(string roleName)
    {
        if (string.IsNullOrEmpty(roleName))
        {
            ...
            Role Role = null;
            Role = this.Context.Roles.FirstOrDefault(Rl => Rl.RoleName == roleName);
            if (Role != null)
            {
                return true;
            }
    ...
    public override bool IsUserInRole(string username, string roleName)
    {
        ...
        User User = null;
        User = this.Context.Users.FirstOrDefault(Usr => Usr.Username == username);
        if (User == null)
        {
            return false;
        }
        Role Role = this.Context.Roles.FirstOrDefault(Rl => Rl.RoleName == roleName);
        if (Role == null)
        {
            return false;
        }
    ...
    {
        return this.Context.Roles.Select(Rl => Rl.RoleName).ToArray();
    }
